...
import { Home, CheckCircle2, Calendar, ChevronDown, ChevronUp, Plus, Minus, ExternalLink  } from "lucide-react";
...
export default function ProjectManagementPage() {
 ...
 why: {
  ...
  const tableOfContents = [
    { id: 'what-is-pm-software', title: 'What is project management software?', active: true },
    { id: 'best-pm-software', title: 'What is the best project management software?' },
    { id: 'find-new-software', title: 'Find your new project management software' },
    { id: 'common-features', title: 'Common project management software features' },
    { id: 'how-to-choose', title: 'How to choose the right PM software for your project' },
    { id: 'pm-faqs', title: 'Project management software FAQs' }
  ];
  ...
  return (
    ...
    <Head>
        ...
        <meta name="description" content="Comprehensive guide to choosing the best project management software for your business needs." />
        ...
        <meta name="twitter:image" content="https://technology-advice.vercel.app/images/project-preview.jpg" />
...
<div className="lg:w-80 lg:sticky lg:top-24 lg:self-start">
  <div
    ...
    style={{ scrollBehavior: 'smooth' }} // Add smooth scroll behavior inline
  >
    ...
    <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Project management (PM) software helps businesses and organizations achieve their goals and objectives 
                    more efficiently and effectively. It guides project managers and stakeholders through different{' '}
                  ...
                  <p className="text-gray-700 leading-relaxed mb-8">
                    ...
                    <a href="#" className="text-green-600 hover:text-green-700 underline">project planning</a>,{' '}
                    <a href="#" className="text-green-600 hover:text-green-700 underline">scheduling</a>,{' '}
                    <a href="#" className="text-green-600 hover:text-green-700 underline">task management</a>, and resource allocation, the 
                    right{' '}
                    <a href="#" className="text-green-600 hover:text-green-700 underline">project management</a>{' '}
                    tool enables teams to streamline the intricate project management process. 
                    Furthermore, these PM software solutions help stakeholders stay on the same page through features that 
                    enhance file sharing, communication, and{' '}
                    <a href="#" className="text-green-600 hover:text-green-700 underline">collaboration</a>.
                  </p>

                  <p className="text-gray-700 leading-relaxed mb-6">
                    I reviewed seven project management software solutions and narrowed my list of recommendations to the 
                    best of the best:
                  </p>
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-gray-700">
                        <a href="#" className="text-green-600 hover:text-green-700 font-medium underline">monday.com</a>{' '}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-gray-700">
                        <a href="#" className="text-green-600 hover:text-green-700 font-medium underline">Asana</a>{' '}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-gray-700">
                        <a href="#" className="text-green-600 hover:text-green-700 font-medium underline">Wrike</a>{' '}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-gray-700">
                        <a href="#" className="text-green-600 hover:text-green-700 font-medium underline">Jira</a>{' '}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-gray-700">
                        <a href="#" className="text-green-600 hover:text-green-700 font-medium underline">ClickUp</a>{' '}
                        ...
                        <div className="px-4 pb-4 border-t border-gray-200">
                          <div className="pt-4">
                            <p className="text-gray-700 mb-4">
                              Last updated: June 2025 - Updated with the latest features and pricing information for all recommended project management tools.
                            </p>
                            <ul className="space-y-2 text-gray-700">
                              <li>• Added new integration capabilities for Monday.com</li>
                              <li>• Updated Asana's pricing structure</li>
                              <li>• Included latest Jira automation features</li>
                              <li>• Enhanced comparison criteria based on user feedback</li>
                            </ul>
                          </div>
                        </div>
                      )}
                      ...
                      {expandedSections['methodology'] && (
                        <div className="px-4 pb-4 border-t border-gray-200">
                          <div className="pt-4 space-y-4">
                            ...
                            <p className="text-gray-700">
                              First, I evaluated seven of the leading project management software options available today. To 
                              compile my research, I reviewed vendor demos, technical documentation, and user reviews from 
                              customers like you.
                            </p>
                            <p className="text-gray-700">
                              I then narrowed my selections to the platforms that best addressed the usual concerns among project 
                              management software users: task management, automation capabilities, integration, collaboration, 
                              scalability, project planning, and resource management.
                            </p>
                            <p className="text-gray-700 mb-4">
                              During our research, I evaluated the following vendors:
                            </p>
                            <ol className="space-y-2 text-gray-700">
                              <li>1. <a href="#" className="text-green-600 hover:text-green-700 underline">monday.com</a></li>
                              <li>2. <a href="#" className="text-green-600 hover:text-green-700 underline">Jira</a></li>
                              <li>3. <a href="#" className="text-green-600 hover:text-green-700 underline">Trello</a></li>
                              <li>4. <a href="#" className="text-green-600 hover:text-green-700 underline">Asana</a></li>
                              <li>5. <a href="#" className="text-green-600 hover:text-green-700 underline">Airtable</a></li>
                              <li>6. <a href="#" className="text-green-600 hover:text-green-700 underline">Wrike</a></li>
                              <li>7. <a href="#" className="text-green-600 hover:text-green-700 underline">ClickUp</a></li>
                            </ol>
                            <p className="text-gray-700 mt-4">
                              As the market evolves, I continually reevaluate my choices so you always receive the best insight for 
                              purchasing decisions.
                            </p>

                            {/* Evaluation Rubric */}
                            <div className="mt-6">
                              <h4 className="text-xl font-semibold text-gray-900 mb-4">Evaluation rubric</h4>
                              <div className="overflow-x-auto">
                                <table className="w-full border-collapse border border-gray-300">
                                  <tbody>
                                    {evaluationCriteria.map((item, index) => (
                                      <tr key={index} className={index === evaluationCriteria.length - 1 ? 'bg-gray-50 font-semibold' : ''}>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-gray-900">Agile Development, Analytics / Reports, API, and 15 more</div>
                    </div>
                    <div>
     ...
     <div className="bg-white rounded-lg shadow-sm border mt-4 border-gray-200 p-6 sm:p-8">
      {/* Header */}
      <header className="mb-8">
      ...
      <div className="flex flex-col gap-6 mb-8">
        <div>
          <h3 className="text-xl text-black font-semibold mb-2">Pros</h3>
        ...
        <div>
          <h3 className="text-xl text-black font-semibold mb-2">Cons</h3>
          <ul className="list-disc pl-5 text-black space-y-1">
      ...
      {[
        ...
        },
        {
          ...
          content: (
            <>
             <h4 className="text-lg font-bold mb-2">Customizable workflows and boards</h4>
             <p className="text-black mb-4">
              ...
              <h4 className="text-lg font-bold mb-2">Automation capabilities</h4>
              <p className="text-black mb-4">
          ...
          content: (
            <>
              ...
              <ul className="list-disc pl-5 text-black">
                ...
                <li>14-day free trial available, no credit card required.</li>
                <li>Includes Basic plan features, plus:
              ...
              <ul className="list-disc pl-5 text-black">
                ...
                <li>14-day free trial available, no credit card required.</li>
                <li>Includes Standard plan features, plus:
                  <ul className="list-disc pl-5">
              ...
              <ul className="list-disc pl-5 text-black">
                ...
                <li>Includes Pro plan features, plus:
                  <ul className="list-disc pl-5">
        ...
        
        {
          ...
          content: (
            <ul className="list-disc pl-5 text-black space-y-2">
              <li>Visually appealing interface with drag-and-drop features.</li>
              <li>Color-coded statuses for quick understanding.</li>
              <li>Expandable task cards with rich content.</li>
              <li>Clean dashboard layout with charts and metrics.</li>
            </ul>
          ),
        },
        ...
        <div key={label} className="border-t pt-4">
          ...
          {openSection === label && (
            <div className="mt-2 text-black text-sm">{sectionContent}</div>
          )}
        </div>
      ))}
